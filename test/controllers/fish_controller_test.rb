...
class FishControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fish" do
    assert_difference('Fish.count') do
      post fish_index_url, params: { fish: { commonname: @fish.commonname, description: @fish.description, genus: @fish.genus, thumbnail: @fish.thumbnail } }
    end
  ...
  test "should update fish" do
    patch fish_url(@fish), params: { fish: { commonname: @fish.commonname, description: @fish.description, genus: @fish.genus, thumbnail: @fish.thumbnail } }
